# FELÚT+ · Felskálázott, EU-konform projektváltozat
...
> A hazai változat továbbra is érvényes — a kettő párhuzamosan futtatható,
> a hazai pilot referenciaként szolgál az EU-s pályázathoz.

---

## 1. A stratégiai fordulat: mi változik és miért

A felhívás formai küszöbei miatt a 6 hónapos változat nem pályázhat
(180 ezer EUR vs. minimum 800 ezer EUR; 6 hónap vs. 18–24 hónap; nincs
konzorcium). De nem csak méretben kell nőni — **a projekt logikáját is át kell
állítani**, mert a felhívás nem rendezvénysorozatot, hanem
*munkaerőpiaci aktivációs útvonalat* finanszíroz.
...
elemben van a valódi innováció: egy hiteles roma előadó jelenléte olyan
...
### A) Aktivációs sáv — 18–29 éves roma NEET fiatalok
...
*Megjegyzés: a 6–13 éves korosztályra fókuszáló elemek az ESF+ másik
komponensébe (Európai Gyermekgarancia, `ESF-SI-2026-ECG-01`) illenének, de ott
a koordinátornak a nemzeti Gyermekgarancia-koordinátornak kell lennie — civil
szervezet csak társpályázó lehet. Ezt az irányt a hazai EFOP+ Tanoda-forrásból
érdemes vinni.*
...
gyakorlatában jó eredménynek számít — reális, de nem túlígért vállalás.*
...
1. **Hiteles hang mint outreach-technológia.** A roma NEET fiatalok
   ...
   az intézményekkel szemben. A projekt egy mérhető, megismételhető modellt
   tesztel: *egy hiteles közösségi ikon jelenléte mint a szolgáltatásba
   csatornázás eszköze.* Ezt eddig senki nem mérte szisztematikusan.
...
javasolt megtartani, a projekt „társult" elemeként — így a kárpát-medencei
lefedettség nem vész el, de a pályázati jogosultság sem sérül.*
...
- [Konzorciumi térkép és partnerstratégia](konzorcium.md)
- [Angol nyelvű concept note partnerek megkereséséhez](FELUT-PLUS-concept-note-EN.md)
- [Hazai változat (6 hónap, 12 alkalom)](../projektterv.md)
- [Pályázati források áttekintése](../eu-palyazatok.md)
