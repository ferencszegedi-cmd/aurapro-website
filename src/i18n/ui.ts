...
export const ui = {
  hu: {
    ...
    wizard: {
      ...
      svcOnline: 'Online oktatás',
      svcContinuous: 'Folyamatos munka- és tűzvédelmi szolgáltatás',
      company: 'Cég neve',
  ...
  en: {
    ...
    wizard: {
      ...
      svcOnline: 'Online training',
      svcContinuous: 'Ongoing occupational & fire safety service',
